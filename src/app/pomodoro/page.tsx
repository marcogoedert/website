...
import { GridArticle } from '@/ui/templates/grid';
            ...
            <GridArticle>
                ...
                >
                    ...
                    <ol>
                        ...
                        <li>
                            5. 🌳 Every 4 pomodoros, take a longer 15-30 min
                            break
                        </li>
                    </ol>
                    <Separator className='my-4' />
                    ...
                    <div className='grid gap-4 grid-cols-1 md:grid-cols-2'>
                        ...
                        <ul>
                            ...
                            <li className='line-through'>
                                - [x] Add modes: Focus Time, Short Break, Long
                                Break
                            </li>
                            <li className='line-through'>
                                - [x] Add progress bar
                            ...
                            <li>
                                - [ ] Set goal of the day - total pomodoro time
                                today (optional, give it a name - enables
                                multi-goals?)
                            </li>
                        </ul>
                        {/* REPORT */}
                        ...
                        <ul>
                            ...
                            <li>
                                - [ ] (Integration) Add tasks/events from Google
                                Agenda
                            </li>
                            <li>
                                - [ ] (Integration) Add tasks/events from
                                Todoist
                            </li>
                        </ul>
                        {/* SETTINGS */}
                        <ul className='space-y-2'>
                            ...
                            <ul>
                                <label>Timer</label>
                                <li>
                                    - [ ] Change duration of Focus/Short
                                    break/Long break
                                </li>
                            ...
                            <ul>
                                ...
                                <li>
                                    - [ ] (Settings) Repeat N times (default: 1)
                                </li>
                            </ul>
                            {/* SETTINGS - THEME */}
                            <ul>
                                <label>Theme</label>
                                <li>
                                    - [ ] (Settings) Change color theme for
                                    Focus time, Short break, Long break
                                </li>
                                <li>
                                    - [ ] (Settings) Change hour format: 12-hour
                                    or 24-hour
                                </li>
                            </ul>
                        </ul>
                        <ul>
                            ...
                            <li>
                                - [ ] (Feature) Add notification when timer
                                completes
                            </li>
                            <li>
                                - [ ] (Feature) Add reminder when focus time is
                                about to complete
                            </li>
                            <li>
                                - [ ] (Settings) Change reminder for every/last
                                N minutes
                            </li>
