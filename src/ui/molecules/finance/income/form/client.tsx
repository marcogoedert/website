...
import { z } from 'zod';
import { IncomeFormClientProps, LooseIncome } from './types';
...
export function IncomeFormClient({
    income,
    callback,
    categories,
    ...props
}: IncomeFormClientProps): JSX.Element {
        ...
        <Form {...form}>
            ...
            >
                ...
                <div className='flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2'>
                    ...
                    {!(!virtualIncome?.id || form.formState.isSubmitting) && (
                        <Button
                            variant='destructive'
                            onClick={onDelete}
                            disabled={
                    ...
                    >
                        {virtualIncome?.id ? 'Save changes' : 'Create income'}
                    </Button>
                </div>
            </form>
        </Form>
